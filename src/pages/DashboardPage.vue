    ...
    >
      ...
      <div>
        <ul>
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 fill-red-500" viewBox="0 0 512 512">
              <path
            ...
            <router-link to="/dashboard">
              <span class="text-red-500 text-xl ml-4">Dashboard</span>
            </router-link>
          </li>
          <li class="flex items-center my-2 py-6 px-6 mr-8 rounded-r-full cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 fill-red-500" viewBox="0 0 448 512">
              <path
                d="M224 256c70.7 0 128-57.31 128-128s-57.3-128-128-128C153.3 0 96 57.31 96 128S153.3 256 224 256zM274.7 304H173.3C77.61 304 0 381.6 0 477.3c0 19.14 15.52 34.67 34.66 34.67h378.7C432.5 512 448 496.5 448 477.3C448 381.6 370.4 304 274.7 304z"
              />
            </svg>
            <router-link to="/user">
              <span class="text-red-500 text-xl ml-4">Users</span>
            </router-link>
          </li>
          <li class="flex items-center my-2 py-6 px-6 mr-8 rounded-r-full cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 fill-red-500" viewBox="0 0 448 512">
            ...
            <router-link to="/request">
              <span class="text-red-500 text-xl ml-4">Withdrawal Requests</span>
            </router-link>
          </li>
          <li class="flex items-center my-2 py-6 px-6 mr-8 rounded-r-full cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 fill-red-500" viewBox="0 0 448 512">
            ...
            <router-link to="/request">
              <span class="text-red-500 text-xl ml-4">Withdrawal Posted</span>
            </router-link>
          </li>
          <li class="flex items-center my-2 py-6 px-6 mr-8 rounded-r-full cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 fill-red-500" viewBox="0 0 448 512">
            ...
            <router-link to="/request">
              <span class="text-red-500 text-xl ml-4">Subscriptions</span>
            </router-link>
          </li>
          <li class="flex items-center my-2 py-6 px-6 mr-8 rounded-r-full cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 fill-red-500" viewBox="0 0 448 512">
            ...
            <router-link to="/request">
              <span class="text-red-500 text-xl ml-4">Live Updates</span>
            </router-link>
          </li>
          <li class="flex items-center my-2 py-6 px-6 mr-8 rounded-r-full cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 fill-red-500" viewBox="0 0 448 512">
            ...
            <router-link to="/request">
              <span class="text-red-500 text-xl ml-4">Banner</span>
            </router-link>
          </li>
          ...
          <li class="flex items-center my-2 py-6 px-6 mr-8 rounded-r-full cursor-pointer">
            ...
            <router-link to="/request">
              <span class="text-red-500 text-xl ml-4">Setting</span>
            </router-link>
          </li>
        </ul>
      </div>
