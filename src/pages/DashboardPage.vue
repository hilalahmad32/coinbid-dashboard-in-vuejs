        ...
        <ul>
          <router-link to="/">
            ...
            >
              ...
              <span class="text-red-400 text-lg ml-4">Dashboard</span>
            </li>
          </router-link>
          <router-link to="/user">
            <li class="flex items-center my-2 py-6 px-6 mr-8 rounded-r-full cursor-pointer">
              ...
              <span class="text-gray-400 text-lg ml-4">Users</span>
            </li>
          </router-link>
          <router-link to="/request">
            <li class="flex items-center my-2 py-6 px-6 mr-8 rounded-r-full cursor-pointer">
              ...
              <span class="text-gray-400 text-lg ml-4">Withdrawal Requests</span>
            </li>
          </router-link>
          <router-link to="/request">
            <li class="flex items-center my-2 py-6 px-6 mr-8 rounded-r-full cursor-pointer">
              ...
              <span class="text-gray-400 text-lg ml-4">Withdrawal Posted</span>
            </li>
          </router-link>
          <router-link to="/request">
            <li class="flex items-center my-2 py-6 px-6 mr-8 rounded-r-full cursor-pointer">
              ...
              <span class="text-gray-400 text-lg ml-4">Subscriptions</span>
            </li>
          </router-link>
          <router-link to="/request">
            <li class="flex items-center my-2 py-6 px-6 mr-8 rounded-r-full cursor-pointer">
              ...
              <span class="text-gray-400 text-lg ml-4">Live Updates</span>
            </li>
          </router-link>
          <router-link to="/request">
            <li class="flex items-center my-2 py-6 px-6 mr-8 rounded-r-full cursor-pointer">
              ...
              <span class="text-gray-400 text-lg ml-4">Banner</span>
            </li>
          </router-link>
          ...
          <router-link to="/request">
            <li class="flex items-center my-2 py-6 px-6 mr-8 rounded-r-full cursor-pointer">
              ...
              <span class="text-gray-400 text-lg ml-4">Setting</span>
            </li>
          </router-link>
        </ul>
      </div>
